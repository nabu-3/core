 ...
 */
class CNabuRenderTransformInterfaceDescriptor extends CNabuProviderInterfaceDescriptor
{
    ...
    public function __construct(
        ...
        parent::__construct(
            $nb_manager, CNabuProviderFactory::INTERFACE_RENDER_TRANSFORM, $key, $name, $namespace, $class_name
        );
