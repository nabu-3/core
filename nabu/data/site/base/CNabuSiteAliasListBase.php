...
/**
 * Class to manage a list of Site Alias instances.
 * @author Rafael Gutiérrez Martínez <rgutierrez@nabu-3.com>
 * @version 3.0.12 Surface
 * @package \nabu\data\site\base
 */
abstract class CNabuSiteAliasListBase extends CNabuDataObjectList
{
    /**
    ...
    {
        parent::__construct('nb_site_alias_id');
    }
    ...
    /**
     * Acquires an instance of class CNabuSiteAlias from the database.
