 ...
 * ---------------------------------------------------------------------------
 * Created: 2018/01/12 12:34:52 UTC
 * ===========================================================================
...
{
    /**
     * Index the list using the nb_site_map_key field.
     * @var string
     */
    const INDEX_KEY = "keys";

    /**
     * Index the list using the nb_site_map_order field.
     * @var int
     */
    ...
    {
        parent::__construct('nb_site_map_id');
    }
    ...
    {
        $this->addIndex(
            new CNabuDataObjectListIndex($this, 'nb_site_map_key', 'nb_site_map_order', self::INDEX_KEY)
        );
        $this->addIndex(
            new CNabuDataObjectListIndex($this, 'nb_site_map_order', 'nb_site_map_order', self::INDEX_ORDER)
        );
    }

    /**
     * Acquires an instance of class CNabuSiteMap from the database.
