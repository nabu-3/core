 ...
 * ---------------------------------------------------------------------------
 * Created: 2017/04/23 22:38:27 UTC
 * ===========================================================================
...
/**
 * Class to manage a list of Site Alias Host instances.
 * @author Rafael Gutiérrez Martínez <rgutierrez@nabu-3.com>
 * @version 3.0.12 Surface
 * @package \nabu\data\site\base
 */
abstract class CNabuSiteAliasHostListBase extends CNabuDataObjectList
{
    /**
    ...
    {
        parent::__construct('nb_server_host_id');
    }
    ...
    /**
     * Acquires an instance of class CNabuSiteAliasHost from the database.
    ...
    public function acquireItem($key, $index = false)
    {
        ...
        if ($index === false && CNabuEngine::getEngine()->isMainDBAvailable()) {
            $item = new CNabuSiteAliasHost($key);
            if ($item->isFetched()) {
                $retval = $item;
            }
        }
