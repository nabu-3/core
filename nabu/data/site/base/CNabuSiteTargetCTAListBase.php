 ...
 * ---------------------------------------------------------------------------
 * Created: 2018/02/09 10:35:44 UTC
 * ===========================================================================
...
{
    /**
     * Index the list using the nb_site_target_cta_key field.
     * @var string
     */
    const INDEX_KEY = "keys";

    /**
     * Index the list using the nb_site_target_cta_order field.
     * @var int
     */
    ...
    {
        $this->addIndex(
            new CNabuDataObjectListIndex($this, 'nb_site_target_cta_key', 'nb_site_target_cta_order', self::INDEX_KEY)
        );
        $this->addIndex(
            new CNabuDataObjectListIndex($this, 'nb_site_target_cta_order', 'nb_site_target_cta_order', self::INDEX_ORDER)
        );
    }
