...
/**
 * Class to manage a list of Site Module instances.
 * @author Rafael Gutiérrez Martínez <rgutierrez@nabu-3.com>
 * @version 3.0.12 Surface
 * @package \nabu\data\site\base
 */
abstract class CNabuSiteModuleListBase extends CNabuDataObjectList
{
    /**
    ...
    {
        parent::__construct('nb_site_module_id');
    }
    ...
    /**
     * Acquires an instance of class CNabuSiteModule from the database.
