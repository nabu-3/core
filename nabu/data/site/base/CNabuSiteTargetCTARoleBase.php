 ...
 * ---------------------------------------------------------------------------
 * Created: 2017/06/09 12:39:34 UTC
 * ===========================================================================
...
/**
 * Class to manage the entity Site Target CTA Role stored in the storage named nb_site_target_cta_role.
 * @version 3.0.12 Surface
 * @package \nabu\data\site\base
 */
abstract class CNabuSiteTargetCTARoleBase extends CNabuDBInternalObject
{
    /**
     * Instantiates the class. If you fill enough parameters to identify an instance serialized in the storage, then
     * the instance is deserialized from the storage.
     * @param mixed $nb_site_target_cta An instance of CNabuSiteTargetCTARoleBase or another object descending from
     * \nabu\data\CNabuDataObject which contains a field named nb_site_target_cta_id, or a valid ID.
     * @param mixed $nb_role An instance of CNabuSiteTargetCTARoleBase or another object descending from
     * \nabu\data\CNabuDataObject which contains a field named nb_role_id, or a valid ID.
     */
    public function __construct($nb_site_target_cta = false, $nb_role = false)
    {
    ...
    {
        return 'nb_site_target_cta_role';
    }
    ...
    {
        return ($this->isValueNumeric('nb_site_target_cta_id') && $this->isValueNumeric('nb_role_id'))
            ? $this->buildSentence(
                    'select * '
    ...
    /**
     * Gets a filtered list of Site Target CTA Role instances represented as an array. Params allows the capability of
     ...
     */
    public static function getFilteredSiteTargetCTARoleList($q = null, $fields = null, $order = null, $offset = 0, $num_items = 0)
    {
        $fields_part = nb_prefixFieldList(CNabuSiteTargetCTARoleBase::getStorageName(), $fields, false, true, '`');
        $order_part = nb_prefixFieldList(CNabuSiteTargetCTARoleBase::getStorageName(), $fields, false, false, '`');
    ...
    public function setZone(string $zone = "B") : CNabuDataObject
    {
        ...
        $this->setValue('nb_site_target_cta_role_zone', $zone);
