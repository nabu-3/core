 ...
 * ---------------------------------------------------------------------------
 * Created: 2019/10/10 11:56:07 UTC
 * ===========================================================================
 ...
 * @package \nabu\data\site\base
 */
abstract class CNabuSiteStaticContentListBase extends CNabuDataObjectList
{
    /**
     * Index the list using the nb_site_static_content_key field.
     * @var string
     */
    ...
    {
        parent::__construct('nb_site_static_content_id');
    }
    ...
    {
        $this->addIndex(
            new CNabuDataObjectListIndex($this, 'nb_site_static_content_key', 'nb_site_static_content_key', self::INDEX_KEY)
        );
    }

    /**
     * Acquires an instance of class CNabuSiteStaticContent from the database.
    ...
    public function acquireItem($key, $index = false)
    {
        ...
        if ($index === false && CNabuEngine::getEngine()->isMainDBAvailable()) {
            $item = new CNabuSiteStaticContent($key);
            if ($item->isFetched()) {
                $retval = $item;
            }
        }
