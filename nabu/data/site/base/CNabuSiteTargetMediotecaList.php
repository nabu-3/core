 ...
 * ---------------------------------------------------------------------------
 * Created: 2018/08/22 05:46:15 UTC
 * ===========================================================================
...
/**
 * Class to manage a list of Site Target Medioteca instances.
...
abstract class CNabuSiteTargetMediotecaList extends CNabuDataObjectList
{
    ...
    /**
     * Acquires an instance of class CNabuSiteTargetMedioteca from the database.
    ...
    public function acquireItem($key, $index = false)
    {
        ...
        if ($index === false && CNabuEngine::getEngine()->isMainDBAvailable()) {
            $item = new CNabuSiteTargetMedioteca($key);
            if ($item->isFetched()) {
                $retval = $item;
            }
        }
