 ...
 * ---------------------------------------------------------------------------
 * Created: 2018/01/15 16:19:08 UTC
 * ===========================================================================
...
/**
 * Class to manage a list of Commerce instances.
 * @author Rafael Gutiérrez Martínez <rgutierrez@nabu-3.com>
 * @version 3.0.12 Surface
 * @package \nabu\data\commerce\base
 */
abstract class CNabuCommerceListBase extends CNabuDataObjectList
{
    /**
     * Index the list using the nb_commerce_key field.
     * @var string
     */
    ...
    {
        parent::__construct('nb_commerce_id');
    }
    ...
    {
        $this->addIndex(
            new CNabuDataObjectListIndex($this, 'nb_commerce_key', 'nb_commerce_key', self::INDEX_KEY)
        );
    }
