 ...
 * ---------------------------------------------------------------------------
 * Created: 2017/10/18 10:47:19 UTC
 * ===========================================================================
...
/**
 * Class to manage a list of Domain Zone instances.
 * @author Rafael Gutiérrez Martínez <rgutierrez@nabu-3.com>
 * @version 3.0.12 Surface
 * @package \nabu\data\domain\base
 */
abstract class CNabuDomainZoneListBase extends CNabuDataObjectList
{
    /**
    ...
    {
        parent::__construct('nb_domain_zone_id');
    }
    ...
    /**
     * Acquires an instance of class CNabuDomainZone from the database.
