 ...
 * ---------------------------------------------------------------------------
 * Created: 2017/11/21 01:19:44 UTC
 * ===========================================================================
 ...
 */
abstract class CNabuCatalogTaxonomyBase extends CNabuDBInternalObject implements INabuTranslated, INabuHashed
{
    ...
    /**
     * Find an instance identified by nb_catalog_taxonomy_hash field.
     * @param string $hash Hash to search
     * @return CNabuDataObject Returns a valid instance if exists or null if not.
     */
    public static function findByHash(string $hash)
    {
        return CNabuCatalogTaxonomy::buildObjectFromSQL(
                'select * '
                . 'from nb_catalog_taxonomy '
               . "where nb_catalog_taxonomy_hash='%hash\$s'",
                array(
                    'hash' => $hash
                )
        );
    ...
    /**
     * Get Catalog Taxonomy Hash attribute value
     * @return null|string Returns the Catalog Taxonomy Hash value
     */
    public function getHash()
    {
        return $this->getValue('nb_catalog_taxonomy_hash');
    }

    /**
     * Sets the Catalog Taxonomy Hash attribute value.
     * @param string|null $hash New value for attribute
     * @return CNabuDataObject Returns self instance to grant chained setters call.
     */
    public function setHash(string $hash = null) : CNabuDataObject
    {
        $this->setValue('nb_catalog_taxonomy_hash', $hash);
    ...
    /**
     * Get Catalog Taxonomy Attributes attribute value
     * @return null|array Returns the Catalog Taxonomy Attributes value
     */
    public function getAttributes()
    {
        return $this->getValueJSONDecoded('nb_catalog_taxonomy_attributes');
    }

    /**
     * Sets the Catalog Taxonomy Attributes attribute value.
     * @param string|array|null $attributes New value for attribute
     * @return CNabuDataObject Returns self instance to grant chained setters call.
     */
    public function setAttributes($attributes = null) : CNabuDataObject
    {
        $this->setValueJSONEncoded('nb_catalog_taxonomy_attributes', $attributes);
