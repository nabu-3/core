...
abstract class CNabuCatalogLanguageBase extends CNabuDBInternalObject implements INabuTranslation
{
    ...
    {
        $nb_catalog_id = nb_getMixedValue($translated, 'nb_catalog_id');
     ...
     * @return CNabuCatalogLanguageList Returns a list of translations. If no translations are available, the list is
     * empty.
     */
