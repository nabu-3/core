 ...
 * ---------------------------------------------------------------------------
 * Created: 2017/12/11 10:40:08 UTC
 * ===========================================================================
...
/**
 * Class to manage a list of Catalog instances.
 * @author Rafael Gutiérrez Martínez <rgutierrez@nabu-3.com>
 * @version 3.0.12 Surface
 * @package \nabu\data\catalog\base
 */
abstract class CNabuCatalogListBase extends CNabuDataObjectList
{
    /**
     * Index the list using the nb_catalog_key field.
     * @var string
     */
    ...
    {
        parent::__construct('nb_catalog_id');
    }
    ...
    {
        $this->addIndex(
            new CNabuDataObjectListIndex($this, 'nb_catalog_key', 'nb_catalog_key', self::INDEX_KEY)
        );
    }
