 ...
 * ---------------------------------------------------------------------------
 * Created: 2017/04/26 08:36:01 UTC
 * ===========================================================================
...
/**
 * Class to manage a list of Catalog Item Language instances.
 * @author Rafael Gutiérrez Martínez <rgutierrez@nabu-3.com>
 * @version 3.0.12 Surface
 * @package \nabu\data\catalog\base
 */
abstract class CNabuCatalogItemLanguageListBase extends CNabuDataObjectList
{
    /**
    ...
    /**
     * Acquires an instance of class CNabuCatalogItem from the database.
