 ...
 * ---------------------------------------------------------------------------
 * Created: 2018/02/22 05:36:57 UTC
 * ===========================================================================
...
/**
 * Class to manage a list of ServerHost instances.
 * @author Rafael Gutiérrez Martínez <rgutierrez@nabu-3.com>
 * @version 3.0.12 Surface
 * @package \nabu\data\cluster\base
 */
abstract class CNabuServerHostListBase extends CNabuDataObjectList
{
    /**
    ...
    /**
     * Acquires an instance of class CNabuServerHost from the database.
