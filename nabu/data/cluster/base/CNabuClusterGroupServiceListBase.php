 ...
 * ---------------------------------------------------------------------------
 * Created: 2017/03/06 22:29:37 UTC
 * ===========================================================================
...
/**
 * Class to manage a list of Cluster Group Service instances.
 * @author Rafael Gutiérrez Martínez <rgutierrez@wiscot.com>
 * @version 3.0.12 Surface
 * @package \nabu\data\cluster\base
 */
abstract class CNabuClusterGroupServiceListBase extends CNabuDataObjectList
{
    /**
    ...
    {
        parent::__construct('nb_cluster_group_service_id');
    }
    ...
    /**
     * Acquires an instance of class CNabuClusterGroupService from the database.
    ...
    public function acquireItem($key, $index = false)
    {
        ...
        if ($index === false && CNabuEngine::getEngine()->isMainDBAvailable()) {
            $item = new CNabuClusterGroupService($key);
            if ($item->isFetched()) {
                $retval = $item;
            }
        }
