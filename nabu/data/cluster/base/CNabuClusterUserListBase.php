 ...
 * ---------------------------------------------------------------------------
 * Created: 2017/05/11 13:36:14 UTC
 * ===========================================================================
...
/**
 * Class to manage a list of Cluster User instances.
 * @author Rafael Gutiérrez Martínez <rgutierrez@nabu-3.com>
 * @version 3.0.12 Surface
 * @package \nabu\data\cluster\base
 */
abstract class CNabuClusterUserListBase extends CNabuDataObjectList
{
    /**
    ...
    {
        parent::__construct('nb_cluster_user_id');
    }
    ...
    /**
     * Acquires an instance of class CNabuClusterUser from the database.
