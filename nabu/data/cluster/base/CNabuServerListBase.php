 ...
 * ---------------------------------------------------------------------------
 * Created: 2018/02/15 12:53:26 UTC
 * ===========================================================================
...
/**
 * Class to manage a list of Server instances.
 * @author Rafael Gutiérrez Martínez <rgutierrez@nabu-3.com>
 * @version 3.0.12 Surface
 * @package \nabu\data\cluster\base
 */
abstract class CNabuServerListBase extends CNabuDataObjectList
{
    /**
     * Index the list using the nb_server_key field.
     * @var string
     */
    ...
    {
        parent::__construct('nb_server_id');
    }
    ...
    {
        $this->addIndex(
            new CNabuDataObjectListIndex($this, 'nb_server_key', 'nb_server_key', self::INDEX_KEY)
        );
    }

    /**
     * Acquires an instance of class CNabuServer from the database.
