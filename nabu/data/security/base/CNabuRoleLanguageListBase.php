...
/**
 * Class to manage a list of Role Language instances.
 * @author Rafael Gutiérrez Martínez <rgutierrez@nabu-3.com>
 * @version 3.0.12 Surface
 * @package \nabu\data\security\base
 */
abstract class CNabuRoleLanguageListBase extends CNabuDataObjectList
{
    /**
    ...
    /**
     * Acquires an instance of class CNabuRole from the database.
