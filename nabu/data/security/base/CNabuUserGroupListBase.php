 ...
 * ---------------------------------------------------------------------------
 * Created: 2017/12/04 11:40:01 UTC
 * ===========================================================================
...
/**
 * Class to manage a list of User Group instances.
 * @author Rafael Gutiérrez Martínez <rgutierrez@nabu-3.com>
 * @version 3.0.12 Surface
 * @package \nabu\data\security\base
 */
abstract class CNabuUserGroupListBase extends CNabuDataObjectList
{
    /**
    ...
    /**
     * Acquires an instance of class CNabuUserGroup from the database.
