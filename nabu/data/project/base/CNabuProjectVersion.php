 ...
 * ---------------------------------------------------------------------------
 * Created: 2017/03/27 15:50:49 UTC
 * ===========================================================================
 ...
 */
class CNabuProjectVersion extends CNabuDBInternalObject implements INabuTranslated
{
     ...
     * @param mixed $nb_project_version An instance of CNabuProjectVersion or another object descending from
     ...
     * each value is an instance of class CNabuProjectVersion.
    ...
    public static function getAllProjectVersions(CNabuProject $nb_project)
    {
        ...
        } else {    $retval = new CNabuProjectVersionList();
        }
    ...
    public static function getFilteredProjectVersionList($nb_project = null, $q = null, $fields = null, $order = null, $offset = 0, $num_items = 0)
    {
        ...
        if (is_numeric($nb_project_id)) {
            $fields_part = nb_prefixFieldList(CNabuProjectVersion::getStorageName(), $fields, false, true, '`');
            $order_part = nb_prefixFieldList(CNabuProjectVersion::getStorageName(), $fields, false, false, '`');
     ...
     * @return CNabuProjectVersion Returns $this
     */
