 ...
 * ---------------------------------------------------------------------------
 * Created: 2018/02/20 12:55:34 UTC
 * ===========================================================================
...
/**
 * Class to manage a list of Project Version instances.
 * @author Rafael Gutiérrez Martínez <rgutierrez@nabu-3.com>
 * @version 3.0.12 Surface
 * @package \nabu\data\project\base
 */
abstract class CNabuProjectVersionListBase extends CNabuDataObjectList
{
    /**
    ...
    {
        parent::__construct('nb_project_version_id');
    }
    ...
    /**
     * Acquires an instance of class CNabuProjectVersion from the database.
    ...
    public function acquireItem($key, $index = false)
    {
        ...
        if ($index === false && CNabuEngine::getEngine()->isMainDBAvailable()) {
            $item = new CNabuProjectVersion($key);
            if ($item->isFetched()) {
                $retval = $item;
            }
        }
