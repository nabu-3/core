 ...
 * ---------------------------------------------------------------------------
 * Created: 2018/01/15 16:19:25 UTC
 * ===========================================================================
...
/**
 * Class to manage a list of iContact Prospect Attachment instances.
 * @author Rafael Gutiérrez Martínez <rgutierrez@nabu-3.com>
 * @version 3.0.12 Surface
 * @package \nabu\data\icontact\base
 */
abstract class CNabuIContactProspectAttachmentListBase extends CNabuDataObjectList
{
    /**
    ...
    {
        parent::__construct('nb_icontact_prospect_attachment_id');
    }
    ...
    /**
     * Acquires an instance of class CNabuIContactProspectAttachment from the database.
    ...
    public function acquireItem($key, $index = false)
    {
        ...
        if ($index === false && CNabuEngine::getEngine()->isMainDBAvailable()) {
            $item = new CNabuIContactProspectAttachment($key);
            if ($item->isFetched()) {
                $retval = $item;
            }
        }
