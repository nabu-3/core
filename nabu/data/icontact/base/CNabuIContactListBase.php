 ...
 * ---------------------------------------------------------------------------
 * Created: 2018/01/18 10:51:29 UTC
 * ===========================================================================
...
/**
 * Class to manage a list of iContact instances.
 * @author Rafael Gutiérrez Martínez <rgutierrez@nabu-3.com>
 * @version 3.0.12 Surface
 * @package \nabu\data\icontact\base
 */
abstract class CNabuIContactListBase extends CNabuDataObjectList
{
    /**
     * Index the list using the nb_icontact_key field.
     * @var string
     */
    ...
    {
        parent::__construct('nb_icontact_id');
    }
    ...
    {
        $this->addIndex(
            new CNabuDataObjectListIndex($this, 'nb_icontact_key', 'nb_icontact_key', self::INDEX_KEY)
        );
    }

    /**
     * Acquires an instance of class CNabuIContact from the database.
