 ...
 * ---------------------------------------------------------------------------
 * Created: 2018/02/20 16:44:56 UTC
 * ===========================================================================
...
/**
 * Class to manage a list of iContact Prospect instances.
 * @author Rafael Gutiérrez Martínez <rgutierrez@nabu-3.com>
 * @version 3.0.12 Surface
 * @package \nabu\data\icontact\base
 */
abstract class CNabuIContactProspectListBase extends CNabuDataObjectList
{
    /**
    ...
    {
        parent::__construct('nb_icontact_prospect_id');
    }
    ...
    /**
     * Acquires an instance of class CNabuIContactProspect from the database.
    ...
    public function acquireItem($key, $index = false)
    {
        ...
        if ($index === false && CNabuEngine::getEngine()->isMainDBAvailable()) {
            $item = new CNabuIContactProspect($key);
            if ($item->isFetched()) {
                $retval = $item;
            }
        }
