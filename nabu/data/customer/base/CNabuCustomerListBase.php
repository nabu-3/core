 ...
 * ---------------------------------------------------------------------------
 * Created: 2017/04/26 08:35:21 UTC
 * ===========================================================================
...
/**
 * Class to manage a list of Customer instances.
 * @author Rafael Gutiérrez Martínez <rgutierrez@nabu-3.com>
 * @version 3.0.12 Surface
 * @package \nabu\data\customer\base
 */
abstract class CNabuCustomerListBase extends CNabuDataObjectList
{
    /**
    ...
    {
        parent::__construct('nb_customer_id');
    }
    ...
    /**
     * Acquires an instance of class CNabuCustomer from the database.
