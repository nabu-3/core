 ...
 * ---------------------------------------------------------------------------
 * Created: 2018/01/15 16:19:18 UTC
 * ===========================================================================
...
/**
 * Class to manage a list of Medioteca instances.
 * @author Rafael Gutiérrez Martínez <rgutierrez@nabu-3.com>
 * @version 3.0.12 Surface
 * @package \nabu\data\medioteca\base
 */
abstract class CNabuMediotecaListBase extends CNabuDataObjectList
{
    /**
     * Index the list using the nb_medioteca_key field.
     * @var string
     */
    ...
    {
        parent::__construct('nb_medioteca_id');
    }
    ...
    {
        $this->addIndex(
            new CNabuDataObjectListIndex($this, 'nb_medioteca_key', 'nb_medioteca_key', self::INDEX_KEY)
        );
    }

    /**
     * Acquires an instance of class CNabuMedioteca from the database.
