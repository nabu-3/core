...
use \nabu\data\messaging\CNabuMessagingList;
...
abstract class CNabuMessagingBase extends CNabuDBInternalObject implements INabuTranslated, INabuHashed
{
    ...
    public function __construct($nb_messaging = false)
    {
        ...
        $this->translations_list = new CNabuMessagingLanguageList();
    }
    ...
    /**
     * Find an instance identified by nb_messaging_hash field.
     * @param string $hash Hash to search
     * @return CNabuDataObject Returns a valid instance if exists or null if not.
     */
    public static function findByHash(string $hash)
    {
        return CNabuMessaging::buildObjectFromSQL(
                'select * '
                . 'from nb_messaging '
               . "where nb_messaging_hash='%hash\$s'",
                array(
                    'hash' => $hash
                )
        );
