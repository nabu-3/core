 ...
 * ---------------------------------------------------------------------------
 * Created: 2017/03/14 12:23:47 UTC
 * ===========================================================================
...
/**
 * Class to manage a list of Messaging Service Stack Attachment instances.
 * @author Rafael Gutiérrez Martínez <rgutierrez@wiscot.com>
 * @version 3.0.12 Surface
 * @package \nabu\data\messaging\base
 */
abstract class CNabuMessagingServiceStackAttachmentListBase extends CNabuDataObjectList
{
    /**
    ...
    {
        parent::__construct('nb_messaging_service_stack_attachment_id');
    }
    ...
    /**
     * Acquires an instance of class CNabuMessagingServiceStackAttachment from the database.
    ...
    public function acquireItem($key, $index = false)
    {
        ...
        if ($index === false && CNabuEngine::getEngine()->isMainDBAvailable()) {
            $item = new CNabuMessagingServiceStackAttachment($key);
            if ($item->isFetched()) {
                $retval = $item;
            }
        }
