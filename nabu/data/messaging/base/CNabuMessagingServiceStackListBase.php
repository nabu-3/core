 ...
 * ---------------------------------------------------------------------------
 * Created: 2017/03/13 17:24:48 UTC
 * ===========================================================================
...
/**
 * Class to manage a list of Messaging Service Stack instances.
 * @author Rafael Gutiérrez Martínez <rgutierrez@wiscot.com>
 * @version 3.0.12 Surface
 * @package \nabu\data\messaging\base
 */
abstract class CNabuMessagingServiceStackListBase extends CNabuDataObjectList
{
    /**
    ...
    {
        parent::__construct('nb_messaging_service_stack_id');
    }
    ...
    /**
     * Acquires an instance of class CNabuMessagingServiceStack from the database.
    ...
    public function acquireItem($key, $index = false)
    {
        ...
        if ($index === false && CNabuEngine::getEngine()->isMainDBAvailable()) {
            $item = new CNabuMessagingServiceStack($key);
            if ($item->isFetched()) {
                $retval = $item;
            }
        }
