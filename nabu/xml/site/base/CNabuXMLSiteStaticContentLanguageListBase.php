 ...
 * ---------------------------------------------------------------------------
 * Created: 2017/04/23 22:38:45 UTC
 * ===========================================================================
 ...
 * @package \nabu\xml\site\base
 */
abstract class CNabuXMLSiteStaticContentLanguageListBase extends CNabuXMLTranslationsList
{
    /**
     * Instantiates the class. Receives as parameter a qualified CNabuSiteStaticContentLanguageList class.
     * @param CNabuSiteStaticContentLanguageList $nb_site_static_content_lang $this->entity_name instance to be managed
     * as XML
     */
    public function __construct(CNabuSiteStaticContentLanguageList $nb_site_static_content_lang)
    {
