...
abstract class CNabuXMLSiteTargetCTABase extends CNabuXMLTranslated
{
    ...
    protected function locateDataObject(SimpleXMLElement $element, CNabuDataObject $data_parent = null) : bool
    {
        ...
        if (isset($element['GUID'])) {
            ...
            if (!($this->nb_data_object instanceof CNabuSiteTargetCTA)) {
                $this->nb_data_object = CNabuSiteTargetCTA::findByHash($guid);
            } else {
                $this->nb_data_object = null;
            }
        
            if (!($this->nb_data_object instanceof CNabuSiteTargetCTA)) {
                $this->nb_data_object = new CNabuSiteTargetCTA();
    ...
    /**
     * Get default attributes of Site Target CTA from XML Element.
    ...
    /**
     * Set default attributes of Site Target CTA in XML Element.
    ...
    /**
     * Get default childs of Site Target CTA from XML Element as Element > CDATA structure.
