 ...
 * ---------------------------------------------------------------------------
 * Created: 2018/08/22 05:46:19 UTC
 * ===========================================================================
 ...
 * @package \nabu\xml\site\base
 */
abstract class CNabuXMLSiteMapListBase extends CNabuXMLDataObjectList
{
    /**
     * Instantiates the class. Receives as parameter a qualified CNabuSiteMapList class.
     * @param CNabuSiteMapList $nb_site_map $this->entity_name instance to be managed as XML
     */
    public function __construct(CNabuSiteMapList $nb_site_map)
    {
    ...
    protected function locateDataObject(SimpleXMLElement $element, CNabuDataObject $data_parent = null) : bool
    {
        ...
        if (isset($element['GUID'])) {
            ...
            if (!($this->nb_data_object instanceof CNabuSiteMapList)) {
                $this->nb_data_object = CNabuSiteMapList::findByHash($guid);
            } else {
                $this->nb_data_object = null;
            }
        
            if (!($this->nb_data_object instanceof CNabuSiteMapList)) {
                $this->nb_data_object = new CNabuSiteMapList();
