 ...
 * ---------------------------------------------------------------------------
 * Created: 2019/04/03 22:59:26 UTC
 * ===========================================================================
...
use \nabu\xml\site\CNabuXMLSiteTarget;
 ...
 * @package \nabu\xml\site\base
 */
abstract class CNabuXMLSiteTargetListBase extends CNabuXMLDataObjectList
{
    /**
     * Instantiates the class. Receives as parameter a qualified CNabuSiteTargetList class.
     * @param CNabuSiteTargetList $nb_site_target $this->entity_name instance to be managed as XML
     */
    public function __construct(CNabuSiteTargetList $nb_site_target)
    {
    ...
    protected function locateDataObject(SimpleXMLElement $element, CNabuDataObject $data_parent = null) : bool
    {
        ...
        if (isset($element['GUID'])) {
            ...
            if (!($this->nb_data_object instanceof CNabuSiteTargetList)) {
                $this->nb_data_object = CNabuSiteTargetList::findByHash($guid);
            } else {
                $this->nb_data_object = null;
            }
        
            if (!($this->nb_data_object instanceof CNabuSiteTargetList)) {
                $this->nb_data_object = new CNabuSiteTargetList();
