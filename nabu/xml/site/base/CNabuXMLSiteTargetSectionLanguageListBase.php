 ...
 * ---------------------------------------------------------------------------
 * Created: 2019/04/03 22:59:29 UTC
 * ===========================================================================
...
abstract class CNabuXMLSiteTargetSectionLanguageListBase extends CNabuXMLTranslationsList
{
    ...
    protected function locateDataObject(SimpleXMLElement $element, CNabuDataObject $data_parent = null) : bool
    {
        ...
        if (isset($element['GUID'])) {
            ...
            if (!($this->nb_data_object instanceof CNabuSiteTargetSectionLanguageList)) {
                $this->nb_data_object = CNabuSiteTargetSectionLanguageList::findByHash($guid);
            } else {
                $this->nb_data_object = null;
            }
        
            if (!($this->nb_data_object instanceof CNabuSiteTargetSectionLanguageList)) {
                $this->nb_data_object = new CNabuSiteTargetSectionLanguageList();
