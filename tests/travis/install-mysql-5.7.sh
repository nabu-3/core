...
sudo mysql -e "create schema if not exists 'nabu-3' default charset set='utf8mb4' default collate='utf8mb4_general_ci'; grant all on 'nabu-3'.* to 'nabu-3'@'%' identified by 'nabu-3' with grant option;"
